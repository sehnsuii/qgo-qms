  ...
  @else
    ...
    <div class="flex flex-col">
      <div class="flex flex-row gap-2">
        <form method="POST" action="{{ route('counter.wait', $counter) }}">
          @csrf
          @method('PATCH')
        ...
        <form method="POST" action="{{ route('counter.complete', $counter) }}">
          @csrf
          @method('PATCH')
        ...
        <form method="POST" action="{{ route('counter.cancel', $counter) }}">
          @csrf
          @method('PATCH')
